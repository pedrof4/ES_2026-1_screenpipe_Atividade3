...
Este ponto analisa a qualidade e a granularidade das validações feitas pelos desenvolvedores no código-fonte. 
...
Este ponto mede a extensão dos seus testes, funcionando como um termômetro de segurança do repositório. 
...
Este ponto analisa a automação e a infraestrutura que protege o projeto contra o erro humano. 
